...
public class SelectLocation extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setting.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent intent = new Intent(SelectLocation.this, EnterSelect.class);
	...
	protected void onStart() {
		// TODO Auto-generated method stub
		super.onStart();
		titleText.setText("默认地区：" + pref.getString("default_county_name", "沈阳"));
		showProvinces();
	}
	...
	private synchronized void showCitiesOfProvince() {
		synchronized (this) {
			list.clear();
			//titleText.setText(provinceName + "·省级");
